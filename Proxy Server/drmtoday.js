...
//             "profile": {
//                 "rental": {
//                     "absoluteExpiration":"2020-12-19T11:40:00.000Z", "playDuration": 300000
//                 }
//             },
//             "outputProtection": {
//                 "digital": false,
...
//         }
//         console.log("DRMToday.js",keyMessage.length);
//         // outputFormat = "octet-stream"
//         // body = keyMessage
//         restapi.callRestDRMAPI(method, url, headers, keyMessage).then(response => {
//             var drmKey;
...
let getAuthforDRMrequest = (assetId) => {
    return new promise((resolve, reject) => {
        ...
        let crt = {
            ...
            "profile": {
                "rental": {
                    "absoluteExpiration": expiration, "playDuration": 5000
                }
            },
            "outputProtection": {
                "digital": false,
